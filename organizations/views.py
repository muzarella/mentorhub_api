...
def vendor_home(request, unique_id):
    vendor = get_object_or_404(Organization, id=unique_id)
    return HttpResponse(f"Welcome to the homepage for {vendor.OrganizationName}'s organization!")
